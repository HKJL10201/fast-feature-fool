...
def vgg19(input):
    ...
    weights_path = os.path.join('weights', 'vgg19.npy')
    if not os.path.isfile(weights_path):
        print('Downloading VGG-19 weights...')
        urlretrieve ("https://www.dropbox.com/s/e1v93adr4igwuct/vgg19.npy?raw=1", os.path.join('weights', 'vgg19.npy'))
    net = np.load('weights/vgg19.npy',allow_pickle=True,encoding="latin1").item()
    weights = {}
    biases = {}
